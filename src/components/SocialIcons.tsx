...
export function HamburgerIcon2(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function HamburgerIcon(props: React.ComponentPropsWithoutRef<'svg'>) {
  return (
